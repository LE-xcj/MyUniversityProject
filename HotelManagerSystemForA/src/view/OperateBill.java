...
public class OperateBill extends JFrame{
	...
	public OperateBill(){
		...
		scrollPane.setBounds(0, 0, 920, 416);
		...
		textField.setBounds(654, 426, 187, 32);
		mainPanel.add(textField);
		
		search=new MyButton("source/print-preview.png", new Rectangle(850, 426, 32, 32));
		mainPanel.add(search);
		
		comboBox=new JComboBox<String>();
		comboBox.setBounds(573, 429, 71, 25);
		setItem();
		...
		this.setBounds(100, 100, 920, 525);
